<div id="container" class="clearfix">
    ...
    <section id="main" role="main" class="clearfix container kk">
        <a id="main-content"></a>
        ...
        <div class="node-header clearfix">
            <div class="row" style="margin:0px 0px;">
                <div class="col-md-4 col-12 submenu-left">
                ...
                <div class="col-md-8 col-12 content-right">
        ...
        <div class="subcontainer">
            ...
            <?php if ($page['sidebar_first']): ?>
                <aside id="sidebar-first" role="complementary" class="col-md-12 col-sm-12 sidebar clearfix">
                    <?php print render($page['sidebar_first']); ?>
                </aside>  <!-- /#sidebar-first -->
            <?php endif; ?>

            <?php if ($page['sidebar_second']): ?>
                <aside id="sidebar-second" role="complementary" class=" col-md-12 col-sm-12 sidebar clearfix">
