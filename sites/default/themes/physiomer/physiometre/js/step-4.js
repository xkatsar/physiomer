...
(function($) {
    ...
    physiometre_step4Draw = function() {
        // Paths metadata
        var background = '/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-4/0.jpg';
        var paths = [
            {
                'id': '1',
                'path': 'M0,0L0,130L451,130L339,364L0,364L0,130L0,0',
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-4/' + ((_stepValue == '' || _stepValue != '1') ? '0' : _stepValue) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-4/' + ((_stepValue == '' || _stepValue != '1') ? '1' : _stepValue) + '.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-4/' + ((_stepValue == '' || _stepValue != '2') ? '0' : _stepValue) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-4/' + ((_stepValue == '' || _stepValue != '2') ? '2' : _stepValue) + '.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-4/' + ((_stepValue == '' || _stepValue != '3') ? '0' : _stepValue) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-4/' + ((_stepValue == '' || _stepValue != '3') ? '3' : _stepValue) + '.jpg")',
                'zones': [
                    {
