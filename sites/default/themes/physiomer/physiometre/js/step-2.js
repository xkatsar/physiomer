...
(function($) {
    ...
    physiometre_step2Draw = function() {
        // Paths metadata
        var background = '/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/0.jpg';
        var paths = [
            {
                'id': '1',
                'path': 'M0,0L439,0L0,326L0,0',
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('1') == -1) ? '0' : '1-1') + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('1') == -1) ? '1-0' : '1-1') + '.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('2') == -1) ? '0' : '2-1') + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('2') == -1) ? '2-0' : '2-1') + '.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('3') == -1) ? '0' : '3-1') + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('3') == -1) ? '3-0' : '3-1') + '.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('4') == -1) ? '0' : '4-1') + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('4') == -1) ? '4-0' : '4-1') + '.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('5') == -1) ? '0' : '5-1') + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-2/' + ((_stepValue == '' || _stepValue.indexOf('5') == -1) ? '5-0' : '5-1') + '.jpg")',
                'zones': [
                    {
