...
(function($) {
    ...
    physiometre_step1Draw = function() {
        // Paths metadata
        var background = '/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-1/0.jpg';
        var paths = [
            {
                'id': '1-1',
                'path': 'M0,0L460,0L242,366L0,366L0,0',
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-1/' + ((_stepValue == '' || _stepValue.indexOf('1-') == -1) ? '0' : _stepValue) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-1/' + ((_stepValue == '' || _stepValue.indexOf('1-') == -1) ? '1-0' : _stepValue) + '.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-1/' + ((_stepValue == '' || _stepValue.indexOf('2-') == -1) ? '0' : _stepValue) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-1/' + ((_stepValue == '' || _stepValue.indexOf('2-') == -1) ? '2-0' : _stepValue) + '.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-1/' + ((_stepValue == '' || _stepValue.indexOf('3-') == -1) ? '0' : _stepValue) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer/physiometre/image-'+lang+'/step-1/' + ((_stepValue == '' || _stepValue.indexOf('3-') == -1) ? '3-0' : _stepValue) + '.jpg")',
                'zones': [
                    {
