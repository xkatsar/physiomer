        ...
        var pathsLeft = [
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer2013/physiometre/image-'+lang+'/step-3/' + ((_stepValueLeft == '' || _stepValueLeft != '1-1') ? '1-0' : _stepValueLeft) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer2013/physiometre/image-'+lang+'/step-3/1-1.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer2013/physiometre/image-'+lang+'/step-3/' + ((_stepValueLeft == '' || _stepValueLeft != '1-2') ? '1-0' : _stepValueLeft) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer2013/physiometre/image-'+lang+'/step-3/1-2.jpg")',
                'zones': [
                    {
        ...
        var pathsRight = [
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer2013/physiometre/image-'+lang+'/step-3/' + ((_stepValueRight == '' || _stepValueRight != '2-1') ? '2-0' : _stepValueRight) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer2013/physiometre/image-'+lang+'/step-3/2-1.jpg")',
                'zones': [
                    {
            ...
            },
            {
                ...
                'backgroundImage': 'url("/sites/default/themes/physiomer2013/physiometre/image-'+lang+'/step-3/' + ((_stepValueRight == '' || _stepValueRight != '2-2') ? '2-0' : _stepValueRight) + '.jpg")',
                'hoverImage': 'url("/sites/default/themes/physiomer2013/physiometre/image-'+lang+'/step-3/2-2.jpg")',
                'zones': [
                    {
