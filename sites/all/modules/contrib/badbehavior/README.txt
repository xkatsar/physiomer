...
2. Download the current release of the BadBehavior PHP scripts from
   http://downloads.wordpress.org/plugin/bad-behavior.2.2.13.zip
   ...
   wget http://downloads.wordpress.org/plugin/bad-behavior.2.2.13.zip
   unzip bad-behavior.2.2.13.zip
   rm bad-behavior.2.2.13.zip
